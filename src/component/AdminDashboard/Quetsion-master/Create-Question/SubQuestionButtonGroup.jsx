...
const SubQuestionButtonGroup = ({ showMainQuestion, handleLongQuestion, handleMcqQuestion }) => {
  const questionTypes = [
    {
      title: "Long Question",
      icon: (
    ...
    },
    {
      title: "Drawing",
      icon: (
        <svg viewBox="64 64 896 896" focusable="false" data-icon="format-painter" width="1em" height="1em" fill="currentColor" aria-hidden="true">
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="64 64 896 896" focusable="false" data-icon="line-chart" width="1em" height="1em" fill="currentColor" aria-hidden="true">
  ...
  return (
    <Fragment>
      <div className="mt-4 text-center max-w-7xl mx-auto px-4">
          ...
          {questionTypes.map((type, index) => (
            ...
            >
              <button
                ...
                className="w-14 h-14 flex items-center justify-center rounded-lg bg-sky-300 text-white cursor-pointer hover:bg-sky-400 transition-colors"
                title={type.title}
              >
                {type.icon}
              </button>
              <span className="text-xs mt-1 text-gray-600">{type.title}</span>
            </div>
          ))}
        </div>
      </div>
...
export default SubQuestionButtonGroup;